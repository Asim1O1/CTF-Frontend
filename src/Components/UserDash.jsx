...
const UserDash = () => {
  return (
    <div>
      ...
      <div className="bg-gray-200 opacity-50 h-[100px] rounded-md ">
        <h2 className='text-black text-Left pt-10 mx-[20px] font-[verdana] font-regular text-[20px]  grid gap-[30px]'>
            Recent Rooms           
        </h2>
        <div className="h-[500px] w-[650px] bg-black">
