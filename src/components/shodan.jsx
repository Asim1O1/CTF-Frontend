...
//         <h1 className="text-xl text-red-500 mb-4">Flag 1: What are the opened ports?</h1>
...
//         <h1 className="text-xl text-red-500 mb-4 mt-8">Flag 2: Which organization this IP belongs to?</h1>
