                ...
                <tr className="bg-gray-200 text-black h-1">
                  ...
                  <th className="py-3 px-4 border-b-2">
                    ...
                    <div className="relative inline-flex ml-4">
                      <FontAwesomeIcon icon={faGlobe} className="absolute left-3 top-3 text-gray-500" />
                      <select
                      ...
                      >
                        ...
                        {data.map((player, index) => (
                          <option key={index} value={player.country}>{player.country}</option>
                        ))}
                      </select>
                    </div>
                  </th>
...
//                   <th className="py-3 px-4 border-b-2">Rank</th>
//                   <th className="py-3 px-4 border-b-2">Name</th>
//                   <th className="py-3 px-4 border-b-2">Score</th>
//                   <th className="py-3 px-4 border-b-2">Country</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 {top10.map(player => (
...
//                     <td className="py-3 px-4 border-b">{player.score}</td>
//                     <td className="py-3 px-4 border-b">
//                       <CountryFlag countryCode={player.country} style={{ width: '30px', height: 'auto' }} />
//                       &nbsp; {player.country}
//                     </td>
//                   </tr>
//                 ))}
...
//                     <td className="py-3 px-4 border-b">{user.score}</td>
//                     <td className="py-3 px-4 border-b">
//                       <CountryFlag countryCode={user.country} style={{ width: '30px', height: 'auto' }} />
//                       &nbsp; {user.country}
//                     </td>
//                   </tr>
//                 )}
